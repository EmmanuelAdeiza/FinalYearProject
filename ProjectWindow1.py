...
from PyQt5.QtWidgets import QApplication, QMainWindow, QAction, QStatusBar, QScrollArea, QFrame, QMessageBox, QFileDialog, \
    QGraphicsView, QHBoxLayout, QPushButton, QTableWidget, QTableWidgetItem, QSizePolicy, QVBoxLayout, QWidget, QAbstractItemView
...
class MyTable(QTableWidget):
    ...
    def addRow(self, name, type, size):
        ...
        cur.execute("insert into task ( NAME, TYPE, SIZE, DATE_ACCESSED, ANALYSED) values (?, ?, ?, ?, ?)",
                    (name, type, size, date_accessed, analysed))
...
class Window(QMainWindow, QGraphicsView):
    ...
    def layoutUI(self):
        ...
        self.exitBtn = QPushButton("Other Side")
        ...
        self.form.addRow('ijiih', 'egf', 'egrr')
    ...
    def OpenFile(self):
        ...
        print(fileSize)
        print(fileName)
        # self.form.addRow(fileName, 'Txt', fileSize)
